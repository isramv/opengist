...
namespace Rocket\Clients\OrganizationsBundle\Tests\Controller;
...
class OrganizationControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'rocket_clients_organizationsbundle_organization[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Update')->form(array(
            'rocket_clients_organizationsbundle_organization[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
